...
export const Projects = () => {
  ...
  return (
    <>
      <section id="projects" className="pt-20 lg:pt-[120px]">
    ...
    <>
      ...
      >
        <div className="relative mb-12">
          ...
          <div className="relative z-10 px-3 -mt-20 text-center bg-white dark:bg-black-121212 rounded-lg shadow-lg mx-7 py-9">
