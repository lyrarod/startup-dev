export const Contact = () => {
  return (
    <section
      id="contact"
      className="min-h-screen flex flex-col justify-center overflow-hidden relative z-10"
    >
      <div className="container px-4 xl:px-0 py-20 lg:py-0">
        <div className="flex flex-wrap -mx-4 lg:justify-between">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="relative p-8 bg-white dark:bg-black-202023 rounded-lg shadow-lg sm:p-12">
              <form>
                <ContactInputBox
                  type="text"
                  name="name"
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="border-[silver]/30 w-full resize-none rounded border py-3 px-[14px] text-base text-black-111 outline-none focus:border-primary focus-visible:shadow-none bg-transparent"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="border-[silver]/30 w-full rounded border py-3 px-[14px] text-base text-black-111 outline-none focus:border-primary focus-visible:shadow-none bg-transparent"
        />
      </div>
    </>
  );
